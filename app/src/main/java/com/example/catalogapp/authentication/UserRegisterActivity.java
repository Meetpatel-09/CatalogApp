...
import com.example.catalogapp.users.MainActivity;
...
public class UserRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnReg.setOnClickListener(view -> validateData());
    ...
    private void uploadData() {
        ...
        reference.child("users").child(Objects.requireNonNull(auth.getCurrentUser()).getUid()).setValue(map).addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                pd.dismiss();
